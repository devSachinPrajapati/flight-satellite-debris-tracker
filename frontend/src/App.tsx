...
import { useSatelliteData } from "./hooks/useSatelliteData";
import { useMapControls } from "./hooks/useMapControls";
// ❌ REMOVE: import { useSearch } from "./hooks/useSearch";
import useFPS from "./hooks/useFPS";
import { useMapManager } from "./hooks/useMapManager";
import { useMarkerManager } from "./hooks/useMarkerManager";
import { useRenderStats } from "./hooks/useRenderStats";
  ...
  return (
    <>
      ...
      <MainLayout>
        ...
        {/* ObjectsList now receives viewport-filtered objects */}
        <ObjectsList
          allAircraft={filteredByViewport.aircraft}
          allSatellites={filteredByViewport.satellites}
          allDebris={filteredByViewport.debris}
          onSelectObject={(data, type) => handleObjectSelect({ type, data })}
          selectedObject={selectedObject}
        />
      </MainLayout>
