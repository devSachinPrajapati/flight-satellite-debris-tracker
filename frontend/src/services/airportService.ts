...
// ): Promise<APIResponse<Airport>> => {
//   try {
//     const response = await fetch(`${API_BASE_URL}/api/airports/${code}`);
...
// ): Promise<APIResponse<AirportSchedule[]>> => {
//   try {
//     const endpoint = `${API_BASE_URL}/api/airports/${iataCode}/schedules/${type}`;
...
// ): Promise<APIResponse<AirportSchedule[]>> => {
//   try {
//     const response = await fetch(`${API_BASE_URL}/api/airports/${iataCode}/delays`);
...
// arrivals: AirportSchedule[], departures: AirportSchedule[], iataCode: string): Promise<AirportStats> => {
//   try {
