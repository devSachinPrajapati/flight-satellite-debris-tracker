            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <span className="font-semibold text-green-600">
                  {obj.altitude.toFixed(2)} km
                </span>
              </div>
              <div>
                <span className="text-gray-600 block">Velocity</span>
                <span className="font-semibold text-green-600">
                  {obj.velocity.toFixed(2)} km/s
                </span>
              </div>
            </div>
          </div>
