# """
# Satellite Data Service - FIXED TO INCLUDE TLE DATA
# """
# import asyncio
...
#         """🔧 FIXED: Calculate current position AND INCLUDE TLE DATA"""
...
#             # 🔧 CRITICAL FIX: Include TLE data in the response
#             return {
#                 "norad_id": norad_id,
#                 "name": tle_data["name"],
...
#                 # ✅ ADD TLE DATA FOR ORBIT CALCULATIONS
#                 "tle": {
#                     "name": tle_data["name"],
#                     "line1": tle_data["tle1"],
#                     "line2": tle_data["tle2"]
...
#                 "inclination": satellite.model.inclo * 180 / 3.14159,  # Convert radians to degrees
#                 "period_minutes": (2 * 3.14159) / satellite.model.no  # Orbital period in minutes
#             }
#         except Exception as e:
...
#         """Get current positions with TLE data"""
#         positions = []
