// // Airport Live Board & Nearby Airports
...
//       `${AIRLABS_BASE_URL}/airports?iata_code=${code}&api_key=${apiConfig.airLabs.apiKey}`,
//       undefined, 10000 
//     );
...
//     const endpoint =
//       type === 'arrivals'
//         ? `${AIRLABS_BASE_URL}/schedules?arr_iata=${iataCode}&api_key=${apiConfig.airLabs.apiKey}`
//         : `${AIRLABS_BASE_URL}/schedules?dep_iata=${iataCode}&api_key=${apiConfig.airLabs.apiKey}`;
...
//   try {
//     const response = await fetchWithTimeout(
//       `${AIRLABS_BASE_URL}/airports?api_key=${apiConfig.airLabs.apiKey}`, undefined, 15000 
//     );
...
//         const bearing = calculateBearing(userLat, userLng, airport.lat, airport.lng);
...
// FIX: Get API key from correct path
const getApiKey = () => apiConfig.airLabs.apiKey || apiConfig.airLabs.apiKey || '';
